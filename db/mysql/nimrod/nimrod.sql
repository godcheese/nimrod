...
INSERT INTO `dictionary` VALUES (6, 'MAIL', '电子邮箱发信配置', '用户名', 'USERNAME', 'no-reply@qq.com', 1, 4, 0, '', '2019-02-28 08:34:20', '2018-07-08 15:29:33');
INSERT INTO `dictionary` VALUES (7, 'MAIL', '电子邮箱发信配置', '密码', 'PASSWORD', '', 1, 4, 0, '', '2019-02-28 08:34:36', '2018-07-08 15:29:33');
INSERT INTO `dictionary` VALUES (8, 'MAIL', '电子邮箱发信配置', '显示邮箱', 'FROM', 'no-reply@qq.com', 1, 4, 0, '', '2019-02-28 08:34:27', '2018-07-08 15:29:33');
...
CREATE TABLE `job_runtime_log`  (
  ...
  `job_run_time` bigint(20) NULL DEFAULT NULL COMMENT '任务运行耗时',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Quartz 定时任务运行日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mail`  (
  ...
  `gmt_created` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '电子邮件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of mail
-- ----------------------------
INSERT INTO `mail` VALUES (1, 1, '1', '2', '2', '3', 0, 'Failed messages: com.sun.mail.smtp.SMTPSendFailedException: 501 mail from address must be same as authorization user\n;\n  nested exception is:\n	com.sun.mail.smtp.SMTPSenderFailedException: 501 mail from address must be same as authorization user\n', '3', '2019-02-01 08:46:46', '2019-02-01 08:46:48');
...
INSERT INTO `view_menu` VALUES (14, '定时任务', '', '/quartz/job/page_all', 2, 3, 0, '', '2019-02-11 01:17:37', '2019-02-11 01:17:37');
...
INSERT INTO `view_page` VALUES (18, '发送邮件', '/mail/send', '/MAIL/SEND', 4, 0, '', '2019-02-27 11:30:17', '2018-07-08 13:16:32');
INSERT INTO `view_page` VALUES (19, '邮件队列', '/mail/page_all', '/MAIL/PAGE_ALL', 4, 0, '', '2019-02-27 11:30:23', '2018-07-08 13:17:38');
