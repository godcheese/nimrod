...
sudo mysql -unimrod -p123456 nimrod < db/mysql/quartz/tables_mysql_innodb.sql
sudo mysql -unimrod -p123456 nimrod < db/mysql/flowable/flowable.mysql.all.create.sql