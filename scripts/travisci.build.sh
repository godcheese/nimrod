...
wget -O install.sh https://github.com/godcheese/shell_bag/blob/master/centos/centos7_install_maven3.sh && sh install.sh
wget -O install.sh https://github.com/godcheese/shell_bag/blob/master/centos/centos7_install_mysql57.sh && sh install.sh
