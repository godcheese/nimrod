...
curl -o install.sh https://raw.githubusercontent.com/godcheese/shell_bag/master/jdk/centos7_install_jdk8u202.sh && bash install.sh
curl -o install.sh https://raw.githubusercontent.com/godcheese/shell_bag/master/maven/centos7_install_maven363.sh && bash install.sh
wget -O install.sh https://raw.githubusercontent.com/godcheese/shell_bag/master/mysql/centos7_install_mysql5731.sh && bash install.sh
